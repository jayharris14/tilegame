...
if (newid!=100){
  ...
  if (newid == 100 ) {
    ...
    let y=-45;
    saveid=pastid;
    document.getElementById(100).innerHTML ='<img src="{greenball}" height="35px" width="35px" id="yellow"></img>'
  while(y!=5){
      let z=101;
      y=y+.5;
      for (let i=0; i<10; i++){
...
/*      setTimeout(() => {
  ...
  */
    ...
    document.getElementById(newid - 200).innerHTML =  '<img src="{greenball}" height="35px" width="35px" id="yellow" style="position:absolute; right: 2.3px; top: 2px;"></img>'
    }
    pastid = newid - 200;
      game='on';
      if (lost!='yes'){
  ...
  <div className='Play'>
    ...
    <img src="https://spaceballsimages.s3.us-east-2.amazonaws.com/Space-Balls.png?response-content-disposition=inline&X-Amz-Security-Token=IQoJb3JpZ2luX2VjEIj%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FwEaCXVzLWVhc3QtMiJHMEUCIQDnWIM7%2FN6wNeXogxgtEwHmcLTOyLJLBMKDTDLcZCS5VwIgXjiGmzdVqL5m6s7%2FWdnVL0f64CfHj1aRbumVu%2F9VwLkq7QII0f%2F%2F%2F%2F%2F%2F%2F%2F%2F%2FARAAGgw3MzAzMzU1MDY1MzkiDP5cbwrKLIZa0NDe7SrBAnYYwlxq8aFakpQSvvCjsLZ9cjfTwGA9e3R4VmG6jMlzNIfeuTLOVl0j6yQugdifrnzAC4H7a6HX%2Fx2lkHTaJHYa4X1Grm%2B5HxJWuuusof3CxuZvNe9WwDzeAgEC8GXVuW52fNNJhdnokTNcmbcyIRSLYCBl8LfNcDUtNEWmdmZGCyxPPW9n4NV32GGm7YtdsUyKadE%2B%2FgYX7jXGFFnTgSWma2TMOEKp8SBUpaUfZ2KfG0eC0W7dtm2lvbwLzxcn5LYcRZ%2BCzcnJIzmS99UR0BIhNSU7dPBDmYgEWZfagtka2eAvKn7279S7NkiSlp6ygaJka3Nr2%2BFsEz1gfyO97dv9CY3UQxGSzN2bkxix73xbuYdYWMt6SFQCmL%2FrnC3limal09weQANogqGCf2nbpUXliBiu%2FmBDDh2ib5H6KVAphTDOjP63BjqzAtNJOxPJvPblGYBubWafEQ2Hm%2FnGH1L03i%2Ba8KBEE6pBSQqIEpqi4LYaxUJv6rdOkN0Bg%2FljtdiDC2Ruik9Orfg3JffujPc6WSh709TYCyKVJyKRqWkR2DvjLbgW97Qifm34RtxSNbPbUD6lgD3A68vLxf8UpZMY8X3BpbMx%2FWzMhUnSs%2B27L6CLOu1E6BgT77q3o8ZNrHnK6QMn6FOBjEYhgKU7MKbxrHm%2BuoVms0wB9Ubou6lX67jWUlGjSGn2460pezFA8izZr6A6Yj9Ted%2BpObYWXBALkvTYKQPLBqBsKBBJshdLR5H4TywU1MegSH4Fo34ESWx%2BB5zh6YJrPb43Cm5GF5vk7loY8v%2FnaNZIs5rgV16XKC8MTCM64ZwSMBOSKYQW55%2B8HjI9ulE%2BU9o1u7I%3D&X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20241004T081423Z&X-Amz-SignedHeaders=host&X-Amz-Expires=300&X-Amz-Credential=ASIA2UC3DOBVXIX6IJTG%2F20241004%2Fus-east-2%2Fs3%2Faws4_request&X-Amz-Signature=0906dc78d8af7c56c893ae710a89250a64b2b7ec2b26a069b366c770c1e188cd" style={{position: 'absolute', zIndex: 1, height: 600, width: 1100, top: -130, left: 80}}></img>
      ...
      {(() => { 
        ...
        ledger.push(<div className='greenmove' id='gm' style={{ position: 'absolute', zIndex: 5, left: 1000, top: 105, fontSize: 18, color: 'white', fontFamily: 'monospace' }}> Move <img src="{greenball}" style={{top: 4}} height="30px" width="30px" id="yellow"></img> into the Purple Zone</div>);
